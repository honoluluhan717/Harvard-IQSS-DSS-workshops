...
NotebookDataLength[     83570,       1751]
NotebookOptionsPosition[     56706,       1165]
NotebookOutlinePosition[     82969,       1726]
CellTagsIndexPosition[     82858,       1720]
WindowTitle->Exploring Measures of Association
WindowFrame->Normal*)
...
Cell["Exploring Measures of Association", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`pt$$ = {{-0.5, -0.5}, {0, 0}, {0.5, 0.5}}, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`pt$$], {{-0.5, -0.5}, {0, 0}, {0.5, 
        0.5}}}, {-1, -1}, {1, 1}}}, Typeset`size$$ = {
    400., {233.34375, 238.65625}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`pt$462429$$ = {0, 0}}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`pt$$ = {{-0.5, -0.5}, {0, 0}, {0.5, 0.5}}},
       "ControllerVariables" :> {
        Hold[$CellContext`pt$$, $CellContext`pt$462429$$, {0, 0}]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         ...
         Framed[
          Show[{
            Graphics[
             Map[Point, $CellContext`pt$$]], 
            ListPlot[$CellContext`pt$$, ImageSize -> 450], 
            Plot[
             Evaluate[
              
              Fit[$CellContext`pt$$, {
               1, $CellContext`x}, $CellContext`x]], {$CellContext`x, -1, 1}, 
             PlotStyle -> {Thick, Red}]}, ImageSize -> 390, Axes -> True, 
         ...
         Text[
          Grid[{{"Pearson's rho", 
             NumberForm[
              Correlation[
               Map[First, $CellContext`pt$$], 
               Map[Last, $CellContext`pt$$]], {3, 3}]}, {"Spearman's rho", 
             NumberForm[
              N[
               MultivariateStatistics`SpearmanRankCorrelation[
                Map[First, $CellContext`pt$$], 
                Map[Last, $CellContext`pt$$]]], {3, 3}]}, {"Kendall's tau", 
             NumberForm[
              N[
               MultivariateStatistics`KendallRankCorrelation[
                Map[First, $CellContext`pt$$], 
                Map[Last, $CellContext`pt$$]]], {3, 3}]}}, Frame -> All, 
           ItemSize -> {{8, 5}}]]}, Alignment -> Center], 
      "Specifications" :> {{{$CellContext`pt$$, {{-0.5, -0.5}, {0, 0}, {0.5, 
           0.5}}}, {-1, -1}, {1, 1}, ControlType -> Locator, 
         LocatorAutoCreate -> {3, 
           DirectedInfinity[1]}}}, "Options" :> {AutorunSequencing -> All}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{451., {266., 271.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>((Get["MultivariateStatistics`"]; Null); 
...
Cell[TextData[{
 "Using Alt-Click, add additional data points to the scatter plot above or \
drag the existing data points. The least-squares linear fit to the data \
changes as you add additional data points or drag them. Additionally, three \
sample measures of dependence between the ",
 Cell[BoxData[
  FormBox["X", TraditionalForm]], "InlineMath"],
 " and ",
 Cell[BoxData[
  FormBox["Y", TraditionalForm]], "InlineMath"],
 " coordinates of the data are summarized (viewing the coordinate projections \
as realizations from a pair of random variables)."
}], "ManipulateCaption",
 CellID->134712824],
...
Cell[TextData[{
 "Pearson's correlation coefficient is a popular measurement of association \
between two random variables. It characterizes the extent to which a pair of \
random variables ",
 Cell[BoxData[
  FormBox[
   RowBox[{"(", 
 ...
 " are real-valued constants. Unfortunately, the Pearson correlation \
coefficient completely characterizes the dependence structure between two \
random variables only when the joint distribution of those random variables \
is elliptical. In general, elliptical distributions are those distributions \
with constant curves in ",
 Cell[BoxData[
  FormBox[
   SuperscriptBox["\[DoubleStruckCapitalR]", "n"], TraditionalForm]], 
  "InlineMath"],
 " that are ellipsoids. Additionally, the Pearson correlation coefficient \
only captures the first-order, or linear, association between two random \
variables."
}], "DetailNotes",
 CellID->62593655],

Cell["\<\
There are numerous additional nonlinear measures of association. Some are \
finite dimensional and others are infinite dimensional. Two additional \
finite-dimensional measures of association are Spearman's rho and Kendall's \
tau.\
\>", "DetailNotes",
 CellID->48875773],

Cell[TextData[{
 "Spearman's rho is similar to Pearson's rho, but is computed on the ranks of \
the original data. Kendall's tau is equal to ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"(", 
 ...
 " are a pair of bivariate observations of a random vector ",
 Cell[BoxData[
  FormBox[
   RowBox[{"(", 
    RowBox[{"X", ",", "Y"}], ")"}], TraditionalForm]], "InlineMath"],
 ", then this pair is concordant if ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"sign", "(", 
...
Cell["\<\
Infinite-dimensional measures of dependence include copulas and the local \
correlation function developed by Bjerve and Doksum (1993).\
\>", "DetailNotes",
 CellID->42753483],

Cell[TextData[{
 "For more information on ",
 ButtonBox["Spearman's rho",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://en.wikipedia.org/wiki/Spearman's_rank_correlation_\
coefficient"], None}],
 " and ",
 ButtonBox["Kendall's tau",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://en.wikipedia.org/wiki/Kendall_tau_rank_correlation_\
coefficient"], None}],
...
Cell[TextData[{
 ButtonBox["Copula",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/Copula.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Correlation",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/Correlation.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Statistical Correlation",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/StatisticalCorrelation.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
ExploringMeasuresOfAssociation&version=0010"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/ExploringMeasuresOfAssociation/\
ExploringMeasuresOfAssociation-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 ...
 ButtonBox["http://demonstrations.wolfram.com/ExploringMeasuresOfAssociation/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ExploringMeasuresOfAssociation/"], 
    None},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[39423, 687, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[39684, 696, 3548, 80, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[55884, 1140, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 82571, 1709},
 {"Copyright", 82766, 1714}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1282, 31, 34328, 567, 70, "DemonstrationHeader"],
Cell[35613, 600, 54, 0, 70, "DemoTitle"],
Cell[35670, 602, 3144, 68, 70, "Output",
 CellID->2027672937],
Cell[38817, 672, 603, 13, 70, "ManipulateCaption",
 CellID->134712824],
Cell[39423, 687, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[39684, 696, 3548, 80, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[43235, 778, 52, 1, 70, "DetailsSection",
 CellID->10341923],
Cell[43290, 781, 1264, 33, 70, "DetailNotes",
 CellID->62593655],
Cell[44557, 816, 281, 6, 70, "DetailNotes",
 CellID->48875773],
Cell[44841, 824, 1883, 67, 70, "DetailNotes",
 CellID->59245329],
Cell[46727, 893, 185, 4, 70, "DetailNotes",
 CellID->42753483],
Cell[46915, 899, 449, 15, 70, "DetailNotes",
 CellID->102397969],
Cell[47367, 916, 44, 0, 70, "RelatedLinksSection"],
Cell[47414, 918, 552, 20, 70, "RelatedLinks",
 CellID->340384049],
Cell[47969, 940, 560, 20, 70, "RelatedLinks",
 CellID->7233751],
Cell[48532, 962, 573, 20, 70, "RelatedLinks",
 CellID->700691119],
Cell[49108, 984, 585, 20, 70, "RelatedLinks",
 CellID->277327030],
Cell[49696, 1006, 4829, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[54528, 1097, 45, 0, 70, "CitationSection"],
Cell[54576, 1099, 327, 10, 70, "Author"],
Cell[54906, 1111, 975, 27, 70, "Citations"],
Cell[55884, 1140, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature gSqhS02edwSXcuAX1u6RLA4z *)

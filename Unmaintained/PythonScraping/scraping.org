...
- For example, between early April and late April of 2012, Egypt
   ...
   *All scrapers are brittle.*
   ...
   - The assumptions you're forced to make about how information is
     organized on a given website will not hold forever.
   - In fact, the legality of scraping is not entirely clear, and some
...
#+results[9b798bfaa57e425556bc08059dbf355ef4962f39]: download
==#+NAME: download pages
...
#+results[d427b7ccb323b7fe054b8c344ff6e05a0617c7ea]:
...
#+NAME: basescraper
#+begin_src python :cache no :tangle basescraper.py
  from lxml import etree
  import csv     
  import urllib
  import re
